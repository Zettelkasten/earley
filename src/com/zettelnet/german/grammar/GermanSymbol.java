...
public final class GermanSymbol {
	...
	private static PropertyTypeRegistry<GermanToken> makeDefaultPropertyTypes() {
		...
		registry.register(Adverb, GermanDegree.TYPE, Meaning.TYPE);
		registry.register(Adjective, GermanCasus.TYPE, GermanNumerus.TYPE, GermanGenus.TYPE, GermanDegree.TYPE, Meaning.TYPE);
