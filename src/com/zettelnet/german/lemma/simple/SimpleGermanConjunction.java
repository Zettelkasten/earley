...
public class SimpleGermanConjunction implements GermanLemma {

	private final String firstForm;
	private final PropertySet<GermanLemmaProperty> properties;

	public SimpleGermanConjunction(final String firstForm, final GermanLemmaProperty... properties) {
	...
	public GermanLemmaType getType() {
		return GermanLemmaType.Conjunction;
	}
