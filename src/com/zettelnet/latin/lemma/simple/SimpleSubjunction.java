...
public class SimpleSubjunction implements Lemma {

	private final String firstForm;
	private final PropertySet<LemmaProperty> properties;

	public SimpleSubjunction(final String firstForm, final LemmaProperty... properties) {
